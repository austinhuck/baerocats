...
namespace GroundStation
{
    class Chart3D
    {
        ...
        public GroundStation.Vertex3D this[int n]
        {
            get
            {
        ...
        public Color m_xaxisColor = Color.FromRgb(255, 0, 0);            // axis color
        public Color m_yaxisColor = Color.FromRgb(0, 255, 0);            // axis color
        public Color m_zaxisColor = Color.FromRgb(0, 0, 255);            // axis color
